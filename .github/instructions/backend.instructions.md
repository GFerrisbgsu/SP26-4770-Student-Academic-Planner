...
### Controller Tests (Spring Boot 4.0 Pattern)
**Important**: Spring Boot 4.0.2 removed `@WebMvcTest` and `@AutoConfigureMockMvc`. Use manual MockMvc configuration:
...
class UserControllerTest {
    ...
    private ObjectMapper objectMapper = new ObjectMapper();  // Manual creation
    ...
    void testGetAllUsers() throws Exception {
        List<UserDTO> users = List.of(new UserDTO(1L, "user1", "user1@test.com", LocalDateTime.now()));
...
See [UserControllerTest.java](../../backend/src/test/java/com/sap/smart_academic_calendar/controller/UserControllerTest.java) for complete examples.

## Important Files

### Backend Core
- [Init.java](../../backend/src/main/java/com/sap/smart_academic_calendar/Init.java) - `@SpringBootApplication` entry point
- [pom.xml](../../backend/pom.xml) - Maven dependencies and build configuration
- [application.properties](../../backend/src/main/resources/application.properties) - Base configuration with profile selection

### Configuration
- [application-local.properties](../../backend/src/main/resources/application-local.properties) - H2 in-memory database
- [application-dev.properties](../../backend/src/main/resources/application-dev.properties) - PostgreSQL configuration
- [CorsConfig.java](../../backend/src/main/java/com/sap/smart_academic_calendar/config/CorsConfig.java) - CORS settings for frontend
- [FlywayConfig.java](../../backend/src/main/java/com/sap/smart_academic_calendar/config/FlywayConfig.java) - Database migration config

### Database
- [docker-compose.yml](../../backend/docker-compose.yml) - PostgreSQL and pgAdmin container setup
- [V1__init.sql](../../backend/src/main/resources/db/migration/V1__init.sql) - Initial schema migration
- [V2__admin.sql](../../backend/src/main/resources/db/migration/V2__admin.sql) - Admin user seed data

### Example Code
- [UserController.java](../../backend/src/main/java/com/sap/smart_academic_calendar/controller/UserController.java) - REST endpoints example
- [UserService.java](../../backend/src/main/java/com/sap/smart_academic_calendar/service/UserService.java) - Business logic example
- [UserRepository.java](../../backend/src/main/java/com/sap/smart_academic_calendar/repository/UserRepository.java) - Data access example
- [User.java](../../backend/src/main/java/com/sap/smart_academic_calendar/model/User.java) - JPA entity example
...
- [SPRING_BOOT_BASICS.md](../../docs/backend/SPRING_BOOT_BASICS.md) - Beginner guide to Spring Boot concepts
- [DATABASE.md](../../docs/backend/DATABASE.md) - Detailed Docker, PostgreSQL, and Flyway guide
- [CREATING_ENDPOINTS.md](../../docs/backend/CREATING_ENDPOINTS.md) - Step-by-step endpoint creation guide
- [HOW_TO_RUN.md](../../docs/backend/HOW_TO_RUN.md) - Detailed startup instructions
- [Spring Boot Generic Instructions](spring-boot.instructions.md) - General Spring Boot best practices
